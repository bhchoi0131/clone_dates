...
export function WaitlistFormSection() {
  ...
  return (
    <section id="waitlist-form" className="section-shell scroll-mt-24 pt-8">
      <div className="glass mx-auto flex max-w-2xl flex-col items-start gap-4 p-6 sm:p-8">
        ...
        <button
          ...
          className="rounded-2xl bg-gradient-to-r from-neon-pink to-neon-violet px-6 py-3 text-sm font-semibold text-white shadow-glow transition hover:brightness-110"
        >
          Apply to waitlist
        </button>
      </div>
